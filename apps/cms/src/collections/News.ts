      ...
      tabs: [
        ...
        },
        {
          ...
          fields: [
            ...
            {
              name: "sourceName",
              label: "Kaynak Adı (ajans)",
              type: "text",
              admin: { description: "Ajanstan otomatik çekilen haberlerde ajans adı." },
            },
            {
              name: "sourceGuid",
              label: "Kaynak Kimliği (tekilleştirme)",
              type: "text",
              index: true,
              admin: { readOnly: true, description: "Aynı ajans haberini iki kez almamak için." },
            },
          ],
        },
      ],
