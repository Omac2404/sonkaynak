...
export function SocialLinks({
  items,
  itemClassName = "grid h-8 w-8 place-items-center rounded-full text-sk-muted transition hover:bg-sk-red hover:text-white",
  ...
  return (
    <div className="flex items-center gap-1.5">
      {items.map((s) => (
        <a key={s.key} href={s.url} target="_blank" rel="noopener noreferrer" aria-label={s.key} className={itemClassName}>
