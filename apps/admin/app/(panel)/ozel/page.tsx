...
export default async function OzelPage() {
  ...
  return <OrderedPicker slug="ozel" relKey="news" route="/ozel" title="Özel Haberler" items={items} initialIds={ids} max={12} />;
}
