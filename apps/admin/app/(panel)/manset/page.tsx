...
export default async function MansetPage() {
  ...
  return <OrderedPicker slug="manset" relKey="news" route="/manset" title="Manşet" items={items} initialIds={ids} max={10} />;
}
